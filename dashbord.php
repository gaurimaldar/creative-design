...
<body>
      ...
      <nav class="navbar flex1">
        ...
        <li style="color: dodgerblue; font-weight:700; display: flex; align-items: center; cursor: pointer;">Welcome, <?php echo $username; ?>&nbsp; &nbsp;
          <form action="logout.php" method="post">
            <button style="background: transparent; color: #fff; border: none;"> <i type="submit" class="fa-solid fa-arrow-right-from-bracket"></i></button>
  ...
  <section class="home" id="home" style="background: linear-gradient(45deg, rgba(255, 255, 255, 0.2),rgba(0,0,0,.4)), url('image/festival_home.jpg'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: center;">
    <div class="container">
      <h1>Make Memories</h1>
      <p style="max-width: 80%; margin: 0 auto 1rem">At Event Decoration Services, we are dedicated to turning your
        events into
    ...
    <div class="container">
      ...
      <div class="content flex top">
        <div class="left">
          ...
          <p>
            At Event Decoration Services, we are dedicated to turning your events into
            extraordinary experiences. Our passionate team of creative
            professionals strives to bring your vision to life, making every
            moment magical and memorable.
          </p>
          <p>
        ...
        <div class="right">
          <img style="aspect-ratio: 1/1;" src="image/festival_home.jpg" alt="Event Decoration Services Image" />
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="content grid mtop">
        <div class="box">
          ...
          <div class="text">
            ...
            <a href="wedding.php">Book Now <i class="fa-solid fa-long-arrow-alt-right"></i></a>
          </div>
        </div>
        <div class="box">
          <div class="img">
          ...
          <div class="text">
            ...
            <a href="birthday.php">Book Now <i class="fa-solid fa-long-arrow-alt-right"></i></a>
          </div>
        </div>
        <div class="box">
          <div class="img">
          ...
          <div class="text">
            ...
            <a href="festival.php">Book Now <i class="fa-solid fa-long-arrow-alt-right"></i></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- contact -->
  <section class="timer about wrapper" id="contact" style="background-image: url('image/festival_home.jpg');">
  ...
  <footer>
    <div class="container top">
      <div class="subscribe" id="contact">
        ...
        <p>
          Welcome to Creative Design, where imagination becomes reality in every event we craft. With a fusion of
          artistic ingenuity and precision planning, we curate unforgettable experiences. From stunning décor to
          immersive atmospheres, our events are a testament to innovation and creativity.
        </p>
        <div class="input flex">
          <!-- <a href="login.php" style="margin: 0 auto">
            <button class="btn-31">
              <span class="text-container">
                <span class="text">BOOK NOW</span>
              </span>
      ...
      <div class="content grid top">
        <div class="box">
          <a href="#home" class="logo">Event Decoration Services</a>
          <p>
            Elevate your events with Event Decoration Services. We specialize in turning
            ordinary moments into extraordinary memories through our unique
            event decorations and services.
          </p>
        ...
        <div class="box">
          ...
          <ul>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#home">Home</a>
            </li>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#about">About</a>
            </li>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#services">Services</a>
            </li>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#events">Events</a>
            </li>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#gallery">Gallery</a>
            </li>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#testimonials">Testimonials</a>
            </li>
            <li>
              <i class="fas fa-angle-double-right"></i><a style="color: #fff" href="#contact">Contact</a>
            </li>
          </ul>
        </div>
