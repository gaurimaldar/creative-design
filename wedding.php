...
<html lang="en" dir="ltr">
  <head>
    <title>Wedding Decoraiton</title>
  ...
  <body>
    ...
    <section
      ...
      style="
        background: linear-gradient(
          ...
          url('image/wedding_home.jpg');
      "
    >
      <div class="container">
        <h1>Wedding</h1>
        <p style="text-align: center; margin: 0 auto 1rem">
          Discover the place where you have fun & enjoy a lot oin us in
          celebrating the union of two hearts in a mesmerizing wedding ceremony.
          Witness love, joy, and beautiful decorations.
        </p>
        <a href="#book">
          <button class="btn-31">
      ...
      <div class="container">
        ...
        <div class="gallery-container">
          <div class="gallery-image">
            <span>1. ₹20000</span>
            <img src="image/wedding-1.jpg" alt="wedding decoration images" />
          </div>
          <div class="gallery-image">
            <span>2. ₹15000</span>
            <img src="image/wedding-2.jpg" alt="wedding decoration images" />
          </div>
          <div class="gallery-image">
            <span>3. ₹30000</span>
            <img src="image/wedding-3.jpg" alt="wedding decoration images" />
          </div>
          <div class="gallery-image">
            <span>4. ₹25000</span>
            <img src="image/wedding-4.jpg" alt="wedding decoration images" />
          </div>
          <div class="gallery-image">
            <span>5. ₹23000</span>
            <img src="image/wedding-5.jpg" alt="wedding decoration images" />
          </div>
          <div class="gallery-image">
            <span>6. ₹10000</span>
            <img src="image/wedding-6.jpg" alt="wedding decoration images" />
          </div>
          <div class="gallery-image">
            <span>7. ₹35000</span>
            <img src="image/wedding-7.jpg" alt="wedding decoration images" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="form reservation-form bg-black-10">
          <form action="b-book.php" method="POST">
            ...
            <div class="input-wrapper">
              <div class="icon-wrapper">
                ...
                <select name="attendees" class="input-100" required>
                  <option value="1-person">Wedding Design 1</option>
                  <option value="2-person">Wedding Design 2</option>
                  <option value="3-person">Wedding Design 3</option>
                  <option value="4-person">Wedding Design 4</option>
                  <option value="5-person">Wedding Design 5</option>
                  <option value="6-person">Wedding Design 6</option>
                  <option value="7-person">Wedding Design 7</option>
                </select>
            ...
            <a href="dashbord.php.php" style="margin: 0 auto">
    ...
    <section class="gallary top" id="gallery">
      ...
      <div class="owl-carousel owl-theme">
        ...
        <div class="item">
          <img src="image/wedding_home.jpg" alt="wedding Home" />
          <div class="overlay">
            <i class="fab fa-instagram"></i>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="owl-carousel owl-theme mtop">
        <div class="item">
          ...
          <h3>Unforgettable Wedding Decor</h3>
          <p>
            We had the pleasure of working with Event Decoration Services for our
            wedding, and the result was absolutely stunning. The attention to
        ...
        <div class="item">
          ...
          <p>
            Event Decoration Services turned my birthday celebration into an
    ...
    <section
      ...
      id="contact"
      style="background-image: url('image/wedding_home.jpg')"
    >
