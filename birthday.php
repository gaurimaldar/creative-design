...
<html lang="en" dir="ltr">
  <head>
    <title>Birthday Decoration</title>
  ...
  <body>
    ...
    <section
      class="home"
      id="home"
      style="background-image: url('image/birthday_home.jpg')"
    >
      <div class="container">
        <h1>Birthday</h1>
      ...
      <div class="container">
        ...
        <div class="gallery-container">
          <div class="gallery-image">
            <span>1] ₹2000</span>
            <img src="image/birthday-1.jpg" alt="birthday decoration images" />
          </div>
          <div class="gallery-image">
            <span>2] ₹3400</span>
            <img src="image/birthday-2.jpg" alt="birthday decoration images" />
          </div>
          <div class="gallery-image">
            <span>3] ₹2500</span>
            <img src="image/birthday-3.jpg" alt="birthday decoration images" />
          </div>
          <div class="gallery-image">
            <span>4] ₹3800</span>
            <img src="image/birthday-4.jpg" alt="birthday decoration images" />
          </div>
          <div class="gallery-image">
            <span>5] ₹4000</span>
            <img src="image/birthday-5.jpg" alt="birthday decoration images" />
          </div>
          <div class="gallery-image">
            <span>6] ₹2400</span>
            <img src="image/birthday-6.jpg" alt="birthday decoration images" />
          </div>
          <div class="gallery-image">
            <span>7] 1200</span>
            <img src="image/birthday-7.jpg" alt="birthday decoration images" />
          </div>
        </div>
      </div>
    </section>
...
<section class="reservation" id="book">
            ...
            <div class="input-wrapper">
              <div class="icon-wrapper">
                ...
                <select name="attendees" class="input-100" required>
                  <option value="1-person">birthday Design 1</option>
                  <option value="2-person">birthday Design 2</option>
                  <option value="3-person">birthday Design 3</option>
                  <option value="4-person">birthday Design 4</option>
                  <option value="5-person">birthday Design 5</option>
                  <option value="6-person">birthday Design 6</option>
                  <option value="7-person">birthday Design 7</option>
                </select>
    ...
    <section class="gallary top" id="gallery">
      ...
      <div class="owl-carousel owl-theme">
        ...
        <div class="item">
          <img src="image/birthday_home.jpg" alt="birthday Home" />
          <div class="overlay">
            <i class="fab fa-instagram"></i>
          </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel owl-theme mtop">
                <div class="item">
                    ...
                    <h3>Unforgettable Birthday Decor</h3>
                    <p>
                        We had the pleasure of working with Event Decoration Services for our
                        birthday, and the result was absolutely stunning. The attention to
      ...
      <div class="container top">
        ...
        <div class="content grid top">
          <div class="box">
            <a href="#home" class="logo">Event Decoration Services</a>
            <p>
              Join us in celebrating the joyous occasion of [Name]'s birthday!
